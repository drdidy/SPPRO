...
from core.time_utils import at_central, current_central_time
...
def resolve_anchor_bundle(inputs: dict[str, Any]) -> tuple[dict[str, Any], Any | None, str | None]:
    ...
    try:
        ...
        return build_six_line_anchors(es_candles, inputs["prior_session_date"]), es_candles, None
...
def main() -> None:
    ...
    anchor_bundle, es_candles, data_error = resolve_anchor_bundle(inputs)
